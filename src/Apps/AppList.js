...
const AppList = {
  ...
  DescendantReRender: DescendantReRender,
  ComponentUpdatesInAction: ComponentUpdatesInAction,
  ComponentStateBridge: ComponentStateBridge,
  MixedStateBatching: MixedStateBatching,
  UITreeEvalOrder: UITreeEvalOrder,
  UseMemoDemo: UseMemoDemo,
  UseMemoWithChild: UseMemoWithChild,
  HTTPRequestsMain: HTTPRequestsMain,
  HTTPRequestWithRef: HTTPRequestWithRef,
  HTTPRequestWithTimeLimit: HTTPRequestWithTimeLimit,
